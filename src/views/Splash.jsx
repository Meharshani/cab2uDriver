...
const Splash = (props) => {
  ...
  // when you set your apies then remove useeffect fun this code inside the slash
  useEffect(() => {
    ...
    await axios({
      ...
      .then(async response => {
        if (response.data.result.android_latest_version.version_code > app_version_code) {
          navigate_update_app('https://play.google.com/store/apps/details?id=com.cab2u.driver');
        } else {
