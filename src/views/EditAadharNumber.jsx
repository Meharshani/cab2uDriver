...
const EditAadharNumber = (props) => {
    ...
    const check_valid = () => {
        if (aadhar_number) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your aadhar number');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', 'Successfully updated', 'Your aadhar number has been updated.');
                go_back();
            })
            .catch(error => {
                setLoading(false);
