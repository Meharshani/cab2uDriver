...
const EditAccountNumber = (props) => {
    ...
    const check_valid = () => {
        if (account_number) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your account number');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', 'Successfully updated', 'Your account number has been updated.');
                go_back();
            })
            .catch(error => {
                setLoading(false);
