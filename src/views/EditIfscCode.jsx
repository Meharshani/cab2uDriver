...
const EditIfscCode = (props) => {
    ...
    const check_valid = () => {
        if (ifsc_code) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your IFSC code');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', 'Successfully updated', 'Your IFSC code has been updated.');
                go_back();
            })
            .catch(error => {
                setLoading(false);
