...
const EditBankName = (props) => {
    ...
    const check_valid = () => {
        if (bank_name) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your bank name');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', 'Successfully updated', 'Your bank name has been updated.');
                go_back();
            })
            .catch(error => {
                setLoading(false);
